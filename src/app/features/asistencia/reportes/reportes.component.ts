...
@Component({
  ...
  template: `
    <div class="space-y-5">
      <h2 class="text-xl font-bold text-gray-800">Reportes de Asistencia</h2>
      <div class="card p-16 flex flex-col items-center justify-center text-center">
        ...
        <h3 class="text-lg font-semibold text-gray-700 mb-2">Reportes de Asistencia</h3>
...
export class AsistenciaReportesComponent implements OnInit {
  ...
  ngOnInit(): void { this.layout.setTitle('Reportes de Asistencia'); }
}
