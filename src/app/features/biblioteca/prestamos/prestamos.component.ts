...
@Component({
  ...
  template: `
    <div class="space-y-5">
      <h2 class="text-xl font-bold text-gray-800">Prestamos</h2>
      <div class="card p-16 flex flex-col items-center justify-center text-center">
        ...
        <h3 class="text-lg font-semibold text-gray-700 mb-2">Prestamos</h3>
...
export class PrestamosComponent implements OnInit {
  ...
  ngOnInit(): void { this.layout.setTitle('Prestamos'); }
}
